    ...
    <header className="py-[16px] px-[15px] border-b-[1px] border-placeholder-gray h-[80px] md:h-[86px]">
      <div className="max-w-[1024px] flex items-center justify-between mx-auto">
        ...
        <a
          ...
          className="bg-button hover:bg-button-hover py-[12px] px-[14px] rounded-[10px] font-bold text-lg/[1.14] text-center sm:px-[24px] sm:w-[176px] text-white focus:outline-focus-blue focus:outline-[3px]"
        >
          Get Started
        </a>
      </div>
